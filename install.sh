...
#
#   curl -fsSL https://raw.githubusercontent.com/Texarkanine/OptMem/main/install.sh | sh
...
mkdir -p "$DIR"
curl -fsSL https://raw.githubusercontent.com/Texarkanine/OptMem/main/memo -o "$DIR/memo.new"
