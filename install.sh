...
#
#   curl -fsSL https://raw.githubusercontent.com/Texarkanine/OptMem-Split-Split/main.split/install.sh | sh
...
mkdir -p "$DIR"
curl -fsSL https://raw.githubusercontent.com/Texarkanine/OptMem-Split-Split/main.split/memo -o "$DIR/memo.new"
